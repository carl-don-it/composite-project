...
public class TimeIntroduction {
	...
	public static void testInstant() {
		...
		System.out.println(instant1.getEpochSecond());//精确到秒 得到相对于 1970-01-01 00:00:00UTC 的一个时间
	...
	public static void testLocalDateTime() {
		...
		LocalDateTime d5 = LocalDateTime.parse("2013-12-31T23:59:59.999");//999 毫秒 等价于999000000 纳秒
	...
	public static void testNewOldDateConversion() {
		...
		Date date = Date.from(instant), date1 = new Date(), date2;
